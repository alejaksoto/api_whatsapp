...
class MessageHandler {
  ...
  isGreeting(message) {
    const greetings = ["Hola", "hello", "hi", "buenas tardes","ola"];
  ...
  async sendWelcomeMessage(to, messageId, senderInfo) {
    ...
    const welcomeMessage = `Hola ${name}, Bienvenido a BanCoE, Tu tienda de banco en línea. ¿En qué puedo ayudarte hoy?`;
  ...
  async handleAppointmentFlow(to, message) {
    ...
    switch (state.step) {
      ...
      case 'petName':
        ...
        state.step = 'petType';
        response = '¿Qué tipo de servicio es? (por ejemplo: whatsapp, facebook, instagram, etc.)'
        break;
      case 'petType':
